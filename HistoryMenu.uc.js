...
// @description          简单的历史按钮、关闭的标签
// @author               defpt
// @charset              UTF-8
// @version              1.0.1 2013.2.28
// ==/UserScript==
...
location == "chrome://browser/content/browser.xul" && (function () { 
    function createBtn(){
  	...
  	if (!navigator || navigator.palette.id !== "BrowserToolbarPalette") return;
		...
		Historymenu.addEventListener("click",function(event){event.preventDefault();event.stopPropagation();if(event.button==2) toggleSidebar('viewHistorySidebar');}, false);
