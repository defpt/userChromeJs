			...
			<toolbarpalette id="urlbar-icons">\
				<toolbarbutton id="gTranslator" label="翻译器" \
					...
					<menupopup id="gTranslator-contextmenu" \
						...
						<menuseparator/> \
						<menuitem id="fp-check" label="检查更新" oncommand="gTranslator.updateWindow()"></menuitem>\
					</menupopup>\
				</toolbarbutton>\
			</toolbarpalette>\
...
image="data:image/png;base64," \
	...
	updateWindow: function() {
		...
		<window id="donothing" style="padding:20px;" width="300" height="150" title="gTranslator"\
		...
		window.addEventListener("load", function load(event){\
			...
			NetUtil.asyncFetch("'+gTranslator.versionURL+'", function(inputStream) {\
			...
			function update(){\
				...
				Task.spawn(function () {\
					var url ="'+gTranslator.scriptURL+'";\
					yield Downloads.fetch(url,OS.Path.join(selfScript.path,"gTranslator.uc.js"));\
		...
		<hbox><description id="version" class="'+gTranslator.version+'" value="gTranslator '+gTranslator.version+'"></description></hbox>\
