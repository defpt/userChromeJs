...
* [gTranslator](https://github.com/defpt/userChromeJs/blob/master/Translator/gTranslator.uc.js) 谷歌翻译脚本，修改自*Dannylee* 大大的翻译脚本：**左键点击按钮**直接翻译，如果有选中文字就翻译文字，没有就翻译网页。
**右键点击**弹出设置菜单，包括：
      3中语言选择，这是我常用的（这个可随便打开脚本自己添加和修改的）
