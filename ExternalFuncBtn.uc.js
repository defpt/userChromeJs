...
var gExternalFuncButtonM = {
    autohideEmptySubDirs: true,//自动隐藏空子目录
    moveSubDirstoBottom: false,//子目录移动到最下面
    moveablePositonOrInsertafter: true,//按钮是否可移动
    insertafter: 'alltabs-button',//不可移动时 urlbar-icons addon-bar TabsToolbar alltabs-button
    toolbar: {
        //定义主菜单下子目录，加{name: 'separator'}建立分隔线
        subdirs: [{
            name: '辅助编码',
            image: "data:image/png;base64,"
        },
        {
            name: '辅助浏览',
        ...
        {
            name: '其它功能',
            image: "data:image/png;base64,"
        },
        {
            name: 'separator'
        }],
        ...
        //下面定义子菜单功能
        {
            ...
            subdir: '辅助编码',
            image: 'data:image/png;base64,',
            command: 'gBrowser.addTab("http://www.ostools.net/jsbin#javascript");'
        },
        {
            name: '代码格式化',
            subdir: '辅助编码',
            image: 'data:image/png;base64,',
            command: 'gBrowser.addTab("http://www.ostools.net/codeformat/js");'
        },
        {
            name: '代码压缩',
            subdir: '辅助编码',
            image: 'data:image/png;base64,',
            command: 'gBrowser.addTab("http://www.ostools.net/jscompress");'
        },
        {
            name: '代码对比',
            subdir: '辅助编码',
            image: 'data:image/png;base64,',
            command: 'gBrowser.addTab("http://www.ostools.net/diff");'
        },
        {
            name: '编码转换',
            subdir: '辅助编码',
            image: 'data:image/png;base64,',
            command: 'gBrowser.addTab("http://www.ostools.net/encode?type=4");'
        },
        //辅助浏览
        {
            name: 'Bing网页翻译',
        ...
        },
		{
            ...
            command: function() {
                gBrowser.loadURI("javascript:if(typeof%20yXzyxe58==typeof%20alert)yXzyxe58();(function(){%20document.location.href='http://www.google.com/search?q=cache:'+escape(document.location.href)%20})();");
            }
        },
        {
            name: '宽度匹配',
        ...
        //其它功能
        {
            ...
            command: function() {
                var chrome_PATH = "D:\\Program Files\\Mychrome\\Mychrome.exe";
    ...
    init: function() {
        ...
        ExternalFuncBtn.setAttribute("label", "扩展功能");
        ExternalFuncBtn.setAttribute("onclick", "event.preventDefault();event.stopPropagation();");
        ExternalFuncBtn.setAttribute("tooltiptext", "扩展功能按钮");
    ...
    updateToolbar: function() {
        ...
        toolbars.forEach(function(toolbar) {
            ...
            if (currentset.split(",").indexOf("ExternalFuncButtonM-ID") < 0) return;
